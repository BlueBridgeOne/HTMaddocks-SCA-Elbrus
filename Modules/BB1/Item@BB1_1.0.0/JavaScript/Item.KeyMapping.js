		...
		return {
			...
			_name: function(item) {
				...
				if (parent.get('internalid')) {
					...
					return child_name || parent.get('salesdescription') || parent.get('storedisplayname2') || parent.get('displayname') || item_id;
				}

				// Otherwise return its own name
				return item.get('salesdescription') || item.get('storedisplayname2') || item.get('displayname') || item_id;
			}
			...
			,
			_pageHeader: ['salesdescription', 'storedisplayname2', 'displayname']
