...
if(facet_id=="productrange"){//bb1
	show_facet=false;
}
//console.log(JSON.stringify(facet_config));
			// @class Facets.FacetedNavigationItem.View.Context
			var facetDisplayName= facet_config.name || facet_id; //BB1 remove dashes
			if(facetDisplayName){
			facetDisplayName=facetDisplayName.split('-').join(' ')
			}
			var context = {
