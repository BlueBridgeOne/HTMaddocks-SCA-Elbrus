...
<div class="footer-content-banner">
	...
	<div class="footer-content-column">
		<h5 class="footer-content-title" >{{translate 'Get in Touch'}}</h5>
			<p class="bluetext">Maddocks<br />Unit E1-E6<br />capital Point<br />Capital Business Park<br />Parkway<br />Cardiff<br />CF3 2PY<br />United Kingdom</p>

			<p class="bluetext">Email: <a class="bluelink" href="mailto:info@htmaddocks.co.uk">info@htmaddocks.co.uk</a></p>
			<p class="bluetext">Tel: <a class="bluelink" href="tel:+44 (0)29 2167 8888">+44 (0)29 2167 8888</a></p>
	</div>
	...
	<div class="footer-content-payment">
			<p>{{translate 'We accept the following methods of payment:'}}</p>
...
<div class="footer-content-company">
	...
	<div class="footer-content-copyright">
			{{translate '&copy; H.T.Maddocks &amp; Son (Whitchurch) Ltd (2017)'}}
		</div>
</div>
