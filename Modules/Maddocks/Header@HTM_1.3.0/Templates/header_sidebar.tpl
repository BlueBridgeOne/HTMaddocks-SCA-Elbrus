			...
			{{#each categories}}
				...
				{{#if show}}
					<li class="{{#if @last}}header-sidebar-menu-lastoption{{/if}}">
						<a data-touchpoint="home" {{objectToAtrributes this}} {{#if categories}}data-action="push-menu"{{/if}} name="{{text}}">
							{{text}}
						...
						{{#if categories}}
							<ul>
								...
								<li>
									<a data-touchpoint="home" href="#" class="header-sidebar-menu-back" data-action="pop-menu" name="back-sidebar">
								...
								<li>
									...
									<ul>
										...
										<li>
											<a data-touchpoint="home" {{objectToAtrributes ../this}}>
										...
										{{#if show}}
										<li>
											<a data-touchpoint="home" {{objectToAtrributes this}} name="{{text}}">{{text}}</a>
										</li>
										{{/if}}
										{{/each}}
									</ul>
