...
define(
	'SC.Shopping', [
		...
		, 'Backbone', 'jQuery', 'underscore', 'Utils', 'Profile.Model'

		, 'Backbone.Model', 'Backbone.Sync', 'Backbone.Validation.callbacks', 'Backbone.Validation.patterns', 'Backbone.View', 'Backbone.View.render', 'Backbone.View.saveForm', 'Backbone.View.toggleReset', 'Bootstrap.Rate', 'Bootstrap.Slider', 'jQuery.ajaxSetup', 'jQuery.serializeObject', 'jQuery.scPush', 'String.format'
	],
	function(
		Configuration
		...
		, Backbone, jQuery, _, Utils, ProfileModel
	) {
		'use strict';
		...
		jQuery.ajaxPrefilter(function(options) {
			if (options.url) {
				...
				//BB1 check login on any url call.
				if (options.url && options.url.indexOf("/api") > -1) {
