...
<div class="btn-group">
	{{#if isAdvanced}}
		<a type="button" href="{{editUrl}}" class="cart-item-bulk-actions-button-edit" data-toggle="show-in-modal"> {{translate 'Edit'}}</a>
		<button type="button" class="cart-item-bulk-actions-button-expander" data-toggle="dropdown">
			<span class="caret"></span>
		</button>
	{{/if}}
	<ul class="dropdown-menu" role="menu">
	<li><a class="cart-item-actions-item-list-actionable-edit-content-saveforlater" data-action="save-for-later-item" data-internalid="{{lineId}}">
			{{translate 'Save for Later'}}
		</a></li>
	<li><a class="cart-item-actions-item-list-actionable-edit-content-remove" data-action="remove-item" data-internalid="{{lineId}}">
		{{translate 'Remove'}}
	</a></li>
	</ul>
</div>
