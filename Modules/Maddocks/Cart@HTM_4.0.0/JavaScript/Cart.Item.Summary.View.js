	...
	,	getContext: function ()
		{
			...
			var	quantity_available = this.model.get('item').get('_stock')
			var back_order_message = this.model.get('_backOrderMessage')
			...
			,	backOrderItem: this.model.get('quantity') > quantity_available
			,	itemsOnBackOrder: this.model.get('quantity') - quantity_available
			,	quantityAvailable: quantity_available
			,	backOrderMessage: back_order_message
			};
