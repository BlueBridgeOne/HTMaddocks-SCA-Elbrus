	...
	,	getContext: function ()
		{
			...
			return {
				...
				,	thumbnail: this.model.getThumbnail()
					...
					//Custom Fields
				,	specItem: item.get('_specItem')
				,	specialOrderMessage: item.get('_specialOrderMessage')
				,	newItem: item.get('_newItem')
				,	clearanceItem: item.get('_clearanceItem')
				,	offerItem: item.get('_offerItem')
				,	quantityAvailable: item.get('_stock')
