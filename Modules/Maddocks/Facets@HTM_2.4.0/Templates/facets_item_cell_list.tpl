...
<div class="facets-item-cell-list" itemprop="itemListElement"  data-item-id="{{itemId}}" itemscope itemtype="https://schema.org/Product" data-track-productlist-list="{{track_productlist_list}}" data-track-productlist-category="{{track_productlist_category}}" data-track-productlist-position="{{track_productlist_position}}" data-sku="{{sku}}">
	<div class="facets-item-cell-list-left">
		<div class="facets-item-cell-list-image-wrapper">
			{{#if newItem}}
			<div class="facets-item-cell-list-new-item-tag">{{translate 'NEW'}}</div>
			{{/if}}

			{{#if clearanceItem}}
			<div class="facets-item-cell-list-clearance-item-tag">{{translate 'CLEARANCE'}}</div>
			{{/if}}

			{{#if offerItem}}
			<div class="facets-item-cell-list-offer-item-tag">{{translate 'OFFER'}}</div>
			{{/if}}
			{{#if itemIsNavigable}}
	...
	<div class="facets-item-cell-list-right {{#if discontinuedItem}}not-available{{/if}}">
		...
		<div class="facets-item-cell-list-sku" itemprop="sku">{{sku}}</div>
		...
		{{#if clearanceItem}}
		<div class="facets-item-cell-list-clearance-qty">{{translate 'Quantity Available: '}}{{clearanceQty}}</div>
		{{/if}}
