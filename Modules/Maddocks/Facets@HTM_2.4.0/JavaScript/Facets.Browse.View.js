	...
	,	formatFacetTitle: function (facet)
		{
			...
			else
			{
				...
				return _.unescape(_(facet.config.titleToken).translate(value, facet.config.name));
			}
		}
...
var clearAllFacetsLink=this.translator.cloneWithoutFacets().getUrl();
//BB1 change clear link.
clearAllFacetsLink="/Products";
				return new FacetsFacetedNavigationView({
					categoryItemId: this.category && this.category.itemid
				,	clearAllFacetsLink: clearAllFacetsLink
