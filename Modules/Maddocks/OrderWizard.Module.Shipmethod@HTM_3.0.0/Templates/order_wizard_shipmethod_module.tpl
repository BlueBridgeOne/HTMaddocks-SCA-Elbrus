...
<div class="order-wizard-shipmethod-module">
	...
	{{else}}
		...
		{{/if}}
	{{/if}}
	<div class="order-wizard-shipmethod-module-notification-email">
    	<div class="order-wizard-shipmethod-module-label">{{model.__customFieldsMetadata.custbody_salesorder_del_noti_emai.label}}:</div>
    	<input type="email" class="order-wizard-shipmethod-module-input" name="custbody_salesorder_del_noti_emai" value="{{model.options.custbody_salesorder_del_noti_emai}}" placeholder="{{translate 'Example: your@email.com'}}">
	</div>
	<div class="order-wizard-shipmethod-module-notification-sms">
    	<div class="order-wizard-shipmethod-module-label">{{model.__customFieldsMetadata.custbody_salesorder_del_noti_sms.label}}:</div>
    	<input type="phone" class="order-wizard-shipmethod-module-input" name="custbody_salesorder_del_noti_sms" value="{{model.options.custbody_salesorder_del_noti_sms}}" placeholder="{{translate 'Example: 01234 567890'}}">
	</div>
	<div class="order-wizard-shipmethod-module-special-instructions">
    	<div class="order-wizard-shipmethod-module-label">{{translate 'Special Instructions'}}:</div>
    	<input type="text" class="order-wizard-shipmethod-module-input" name="custbody_salesorder_del_spec_instruc" value="{{model.options.custbody_salesorder_del_spec_instruc}}" placeholder="{{translate 'Example: Please leave parcel in box by front door'}}">
	</div>
</div>
