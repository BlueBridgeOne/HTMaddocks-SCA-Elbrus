...
<fieldset class="creditcard-edit-form">
	...
	<div class="creditcard-edit-form">
		...
		<div class="creditcard-edit-form-controls-img-container" data-value="creditcard-img-container">
				<img class="creditcard-edit-form-card-icon"	src="img/mastercard.jpg" alt="Master Card" data-image="creditcard-icon"/>
				<img class="creditcard-edit-form-card-icon"	src="img/visa.jpg" alt="VISA" data-image="creditcard-icon"/>
				<img class="creditcard-edit-form-card-icon"	src="img/maestro.jpg" alt="Maestro" data-image="creditcard-icon"/>			
		</div>
	</div>
