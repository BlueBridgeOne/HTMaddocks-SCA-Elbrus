		...
		<div class="quote-details-row">
			<div class="quote-details-content-col">
				...
				<div class="quote-details-disclaimer-bottom-content">
					{{#if hasSalesrep}}
						<small class="quote-details-disclaimer-message">{{translate 'For immediate assistance contact <strong>$(0)</strong>. For additional information, send an email to <strong>$(1)</strong>.' salesrepName salesrepEmail}}</small>
					{{else}}
						...
						{{#unless model.purchasablestatus.isPurchasable}}
							<div data-type="quote-details-and-order-msg-placeholder">
								<div class="quote-details-msg">
									...
									{{#if hasSalesrep}}
										<p>{{translate 'To place the order please contact <strong>$(0)</strong> or send an email to <strong>$(1)</strong>' salesrepName salesrepEmail}}</p>
									{{else}}
